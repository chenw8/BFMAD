...
if __name__ == '__main__':
    ...
    parser.add_argument('--mode', type=str, default='train', choices=['train', 'memory_initial', 'test'])
    ...
    parser.add_argument('--num_workers', type=int, default=0*torch.cuda.device_count())
